...
import "./Profile.css";
// import adminProfilePic from "../assets/dark-logo.png";
// import deleteIcon from "../assets/delete.png";
// import deleteIconHovered from "../assets/delete-hover.png";
// import openEnvelope from "../assets/open-envelope.png";
// import closeEnvelope from "../assets/close-envelope.png";
// import close_0Btn from "../assets/close_0.png";
// import close_1Btn from "../assets/close_1.png";
// import { ReactComponent as HideIcon } from "../assets/hide.svg";
// import { ReactComponent as UnhideIcon } from "../assets/unhide.svg";
...
// import "./Profile.css";
// import sampleProfilePic from "../assets/images/customer1.jpg";
// import adminProfilePic from "../assets/dark-logo.png";

// const Profile = ({ user }) => {
//   // Sample messages array
//   const messages = [
//     "Your rental is about to end in 2 hours.",
//     "Admin replied: 'Your request has been approved!'",
//     "New message from support: 'Please update your payment details.'",
//     "Reminder: Your rental extension request is pending.",
//     "You have a new invoice for your rental payment.",
//     "Your profile information was updated successfully.",
//     "A new car model is now available for rent!",
//     "Your scheduled rental starts tomorrow at 9 AM.",
//     "Admin: 'Please confirm your latest booking details.'",
//     "Your previous rental has been successfully closed.",
//   ];

//   // Sample rental history
//   const rentalHistory = [
//     "Toyota Vios - Jan 10, 2025 - Jan 15, 2025",
//     "Honda City - Dec 5, 2024 - Dec 10, 2024",
//     "Mitsubishi Mirage - Nov 20, 2024 - Nov 25, 2024",
//     "Ford Everest - Oct 15, 2024 - Oct 20, 2024",
//     "Nissan Almera - Sep 1, 2024 - Sep 7, 2024",
//   ];
...
//           <div className="profile-picture-section">
//             <img
//               src={user?.profilePic || sampleProfilePic}
//               alt="Profile"
//               className="profile-picture"
//             />
//           </div>
...
//         {/* Buttons */}
//         <div className="profile-buttons">
//           <button className="edit-picture-btn">Edit Profile Picture</button>
//           <button className="edit-info-btn">Edit Profile Information</button>
//         </div>
//       </div>
...
//             <div key={index} className="user-message-item">
//               <div className="message-header">
//                 {/* Profile Picture */}
//                 <img
//                   src={adminProfilePic}
...
//                 {/* Message Details */}
//                 <div className="message-info">
//                   <div className="message-name">EMNL Admin</div>
//                   <div className="message-contact">
//                     <span className="message-email">emnl@gmail.com</span>
//                     <span className="message-phone"> | 0912 345 6789</span>
//                   </div>
//                   <div className="message-date">
...
// const Profile = ({ user }) => {
//   // State for handling message overlay
//   const [selectedMessage, setSelectedMessage] = useState(null);
//   const [isClosing, setIsClosing] = useState(false);
//   const [replyMode, setReplyMode] = useState(false); // New state for reply mode
//   const [replyText, setReplyText] = useState(""); // State to store reply message
...
//       email: "emnl@gmail.com",
//       date: "Feb 10, 2025",
//       time: "10:30 AM",
//       content:
//         "Your rental is about to end in 2 hours. Your rental is about to end in 2 hours. Your rental is about to end in 2 hours. Your rental is about to end in 2 hours. Your rental is about to end in 2 hours.",
//     },
//     {
//       id: 2,
//       sender: "EMNL Admin",
...
//       date: "Feb 10, 2025",
//       time: "10:30 AM",
//       content: "Admin replied: 'Your request has been approved!'",
//     },
//     {
//       id: 3,
//       sender: "EMNL Admin",
...
//   // Sample rental history with all details
//   const rentalHistory = [
//     {
//       carName: "Toyota Vios",
//       startDate: "Jan 10, 2025",
//       endDate: "Jan 15, 2025 wolgnvoejsbnwsegkvebsefssefse",
//       startTime: "08:00 AM",
//       endTime: "07:00 PM",
//       location: "Ormoc City",
...
//   const openMessageOverlay = (message) => {
//     setSelectedMessage(message);
//     setReplyMode(false); // Reset reply mode when opening a new message
...
//   const sendReply = () => {
//     if (replyText.trim() === "") return; // Do nothing if empty

//     console.log("Reply Sent:", replyText);
//     alert("Your message has been sent!"); // Notify user (you can replace this with a more elegant UI notification)

//     setReplyText(""); // Clear text field but keep send mode active
//   };
...
//           <div className="profile-picture-section">
//             <img
//               src={user?.profilePic || adminProfilePic}
//               alt="Profile"
//               className="profile-picture"
//             />
//           </div>
...
//               key={message.id}
//               className="user-message-item"
//               onClick={() => openMessageOverlay(message)}
//             >
//               <div className="message-header">
//                 <img
//                   src={message.profilePic}
...
//                     <span className="message-phone"> | {message.contact}</span>
//                   </div>
//                   <div className="message-date">
...
//             <div key={index} className="history-item">
//               {/* Car Image */}
//               <img src={car1} alt="Rented Car" className="history-car-image" />
//               {/* Rental Details */}
//               <div className="history-details">
//                 <p className="car-name">{history.carName}</p>
//                 <p>
//                   <strong>Rental Duration:</strong> {history.startDate} -{" "}
//                   {history.endDate}
//                 </p>
//                 <p>
//                   <strong>Start Time:</strong> {history.startTime}
//                 </p>
//                 <p>
//                   <strong>End Time:</strong> {history.endTime}
//                 </p>
//                 <p>
//                   <strong>Location:</strong> {history.location}
//                 </p>
//                 <p>
//                   <strong>Purpose:</strong> {history.reason}
//                 </p>
//               </div>
//             </div>
//           ))}
...
//                 <p>
//                   {selectedMessage.email} | {selectedMessage.contact}
//                 </p>
//                 <p>
...
//             {/* Reply Textarea (Only Visible When Reply Mode is Active) */}
//             {replyMode && (
//               <textarea
//                 className="reply-textarea"
//                 placeholder="Type your reply..."
...
//                     key={message.id}
//                     className="user-message-item"
//                     style={{ opacity: message.readStatus ? 0.5 : 1 }}
//                     onClick={() => openMessageOverlay(message, "inbox")}
//                   >
//                     <div className="message-read-toggle">
//                       <button
...
//                             |{" "}
//                             <a
//                               href={`tel:${message.contact.replace(/\s/g, "")}`}
//                             >
//                               {message.contact}
//                             </a>
//                           </span>
...
//                 ))
//               ) : (
//                 <p className="empty-message">No inbox messages.</p>
//               )}
//             </>
//           ) : (
//             <>
...
//                     key={message.id}
//                     className="user-message-item"
//                     onClick={() => openMessageOverlay(message, "sent")}
//                   >
//                     <div className="message-header">
//                       <img
//                         src={user.profilePic}
...
//                       />
//                       <div className="message-info">
//                         <div className="message-name">Sent to: EMNL Admin</div>
//                         <div className="message-contact">
//                           <span className="message-email">From: {user.email}</span>
//                           <span className="message-phone">
//                             |{" "}
...
//                   <span className="message-phone">
//                     |{" "}
//                     <a href={`tel:${message.contact.replace(/\s/g, "")}`}>
//                       {message.contact}
//                     </a>
//                   </span>
//                 </div>
...
//               />
//               <div className="message-info">
//                 <div className="message-name">To: EMNL Admin</div>
//                 <div className="message-contact">
...
//                 <p>
//                   {selectedMessage.email} |{" "}
//                   <a href={`tel:${selectedMessage.contact.replace(/\s/g, "")}`}>
//                     {selectedMessage.contact}
//                   </a>
//                 </p>
//                 <p>
...
//   const preventTouch = (e) => {
//     if (showRevertConfirm) e.preventDefault();
//   };

//   // Always listen for these
//   document.addEventListener("mousedown", handleClickOrScroll);
//   document.addEventListener("scroll", handleClickOrScroll);
//   document.addEventListener("touchmove", preventTouch, { passive: false });

//   // Handle scroll lock when revert confirm is shown
