  ...
  <div className="social-icons">
    ...
    >
      <div className="icon-wrapper">
        {fbHovered ? (
          <img src="/assets/fb-filled.png" alt="Facebook" className="social-img" />
        ) : (
                <svg
                  viewBox="0 0 48 48"
                  width="36"
    ...
    >
      <div className="icon-wrapper">
        {igHovered ? (
          <img src="/assets/ig-filled.png" alt="Instagram" className="social-img" />
        ) : (
             <svg
                  viewBox="0 0 48 48"
                  width="36"
    ...
    >
      <div className="icon-wrapper">
        {tkHovered ? (
          <img src="/assets/tk-filled.png" alt="Tiktok" className="social-img" />
        ) : (
         <svg
                  viewBox="0 0 48 48"
                  width="36"
